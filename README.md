# rabbit_1
This is a problem I set myself after learning the basics of C++
...
If the bunny population exceeds 1000 a food shortage must occur killing exactly half of the bunnies (randomly chose
